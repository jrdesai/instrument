    ...
    <div className="flex flex-col h-full bg-background-dark text-slate-100 font-display">
      ...
      <div className="flex flex-col px-4 py-3 border-b border-border-dark bg-panel-dark">
        ...
        <textarea
          ...
          className="w-full h-28 p-3 bg-background-dark text-slate-100 font-mono text-sm resize-none outline-none focus:ring-1 focus:ring-primary border border-border-dark rounded-lg"
