...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Browse and search ASCII and common Unicode characters — codepoints, names, and copy.",
    category: "encoding",
    displayCategory: "Encoding",
    displayCategoryIcon: "data_array",
    roles: ["frontend", "backend", "general"],
    ...
    component: React.lazy(() =>
      import("../tools/ascii-table/AsciiTableTool").then((m) => ({
        default: m.default,
      }))
    ),
    implemented: true,
  ...
  },
  {
    ...
    name: "SRI Generator",
    description:
      "Generate Subresource Integrity hashes (SHA-256, SHA-384, SHA-512) for script and stylesheet tags. Everything runs locally.",
    category: "crypto",
    displayCategory: "Security",
    displayCategoryIcon: "security",
    roles: ["security", "frontend", "general"],
    icon: "verified_user",
    platforms: ["desktop", "web"],
    rustCommand: "tool_sri_generate",
    keywords: [
      "sri",
    ...
    component: React.lazy(() =>
      import("../tools/sri-generator/SriGeneratorTool").then((m) => ({
        default: m.default,
      }))
    ),
    implemented: true,
  ...
  },
  {
    ...
    description:
      "Classify any IPv4 or IPv6 address — type, range, RFC, binary, hex, and decimal. Fully offline.",
    category: "network",
    displayCategory: "Network",
    displayCategoryIcon: "router",
    roles: ["backend", "devops", "general"],
    ...
    component: React.lazy(() =>
      import("../tools/ip-inspector/IpInspectorTool").then((m) => ({
        default: m.default,
      }))
    ),
    implemented: true,
  ...
  },
  {
    ...
    name: "Git Cheatsheet",
    description:
      "Searchable Git command reference with live branch and remote substitution.",
    category: "code",
    displayCategory: "Code",
    displayCategoryIcon: "code",
    roles: ["backend", "general"],
    ...
    component: React.lazy(() =>
      import("../tools/git-cheatsheet/GitCheatsheetTool").then((m) => ({
        default: m.default,
      }))
    ),
    implemented: true,
